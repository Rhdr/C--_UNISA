...
#include "../../AbstractFactoryPattern/heart.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Heart_t, stringdata) + ofs \
...
const QMetaObject Heart::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Heart.data,
      qt_meta_data_Heart,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Heart.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Serializer_t, stringdata) + ofs \
...
const QMetaObject Serializer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Serializer.data,
      qt_meta_data_Serializer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Serializer.stringdata))
